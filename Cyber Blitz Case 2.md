...
## Test: "smoke" test of the CyberBlitz under the Windows 10 operating system
...
| --- | --- | --- | --- |
| 1 | Install game | Zip file extracts without errors - data files and exe in taget location | √ |			
...
## Overall Test Status:
Passed 
Game was able to install on WIndows 10 system. The only minor bug was the ball selection was not able to be selected right away. 

## Run History:
| # |	Run Date |	Run By |	Results |
| --- | --- | --- | --- |
| 1 | dec 03, 2017 |G. Broughton III | Passed with minor bug at ball selection |			
| 2 | | | |			
| 3 | | | |	
