...
## Overall Test Status:
The main menu appeared in proper format in all settings, as well as all displays as shown. Didnt find any bug.

## Run History:
| # |	Run Date |	Run By |	Results |
| --- | --- | --- | --- |
| 1 | dec. 03, 2017 | G. Broughton III | passed all checks no bug found |			
| 2 | | | |			
| 3 | | | |	
