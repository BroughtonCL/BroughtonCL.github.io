...
# Test Case 4 - functional test of the Main Menu (scene 02_MainMenu) when loaded from game start testing both keyboar-moause and game controller input
...
## Overall Test Status:
Able to load all settingds, all main menu components worked well. No bugs found.

## Run History:
| # |	Run Date |	Run By |	Results |
| --- | --- | --- | --- |
| 1 | dec 03, 2017 | G. Broughton III | Passed - no bugs found |			
| 2 | | | |			
| 3 | | | |	
